import { d as dataMediaQueries, s as slideUp, a as slideDown, b as bodyLockToggle, c as bodyLockStatus } from "./common.min.js";
(function polyfill() {
...
function initSliders() {
  if (document.querySelector(".slider-hero", ".slider-testimonial")) {
...
function showMore() {
  ...
  function getHeight(showMoreBlock, showMoreContent) {
    ...
    if (showMoreType === "items") {
      ...
      const showMoreTypeValue = showMoreContent.dataset.flsShowmoreContent ? showMoreContent.dataset.flsShowmoreContent : 75;
